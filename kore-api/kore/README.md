...
- Toda a lógica de negócio, controllers, models, migrations e middlewares da sua aplicação devem ser criados exclusivamente dentro da pasta pp/.
- Para estender comportamentos do framework, crie classes em pp/ herdando das classes base (extends Model, extends Controller, extends Middleware, etc.).
