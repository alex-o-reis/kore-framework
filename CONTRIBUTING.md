...
1. **Imutabilidade do Core (kore/)**:
   ...
   - Mantenha a separação radical entre o motor do framework (kore/) e o código de usuário (pp/).

2. **Traits e Automação de Banco de Dados (pp/traits/)**:
   - **Nunca** crie ou edite arquivos dentro de pp/traits/ manualmente via PR. Os traits são gerados pelo ModelGenerator (php kore.php make:models).
...
- [ ] A alteração não modifica a pasta raits/ manualmente.
