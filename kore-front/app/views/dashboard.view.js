    ...
    render() {
        ...
        let welcomeCard = UI.card(
            ...
            <div class="d-flex gap-2 mt-4">
                ${UI.button('btn-test-modal', 'Abrir Modal de Exemplo', 'btn-primary', { 'data-bs-toggle': 'modal', 'data-bs-target': '#modal-exemplo' })}
                ${UI.button('btn-test-alert', 'Testar Ação UI', 'btn-outline-secondary')}
            </div>`
        );
